...
// Query: *[_type == "frontPageLayout" && name == "main"]{    sideStoriesPrimary[]-> {      _id,      _updatedAt,      authors[]->{name, profilePhoto{asset->{url}}},      title,      "categoryName": category->.name,      excerpt,      "slugCurrent": slug.current,      featuredImage{..., asset->},      "contentWordCount": count(              string::split(                // pt::text extracts plain text for a portable text block                pt::text(content),                " "              )),    },    sideStoriesSecondary[]-> {      _id,      _updatedAt,      authors[]->{name, profilePhoto{asset->{url}}},      title,      "categoryName": category->.name,      excerpt,      "slugCurrent": slug.current,      featuredImage{..., asset->},      "contentWordCount": count(              string::split(                // pt::text extracts plain text for a portable text block                pt::text(content),                " "              )),    },    topStory->{      _id,      _updatedAt,      authors[]->{name, profilePhoto{asset->{url}}},      title,      "categoryName": category->.name,      excerpt,      "slugCurrent": slug.current,      featuredImage{..., asset->},      "contentWordCount": count(          string::split(            // pt::text extracts plain text for a portable text block            pt::text(content),            " "          )),    }}[0]
