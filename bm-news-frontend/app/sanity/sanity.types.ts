...
// Query: //*[_type == "frontPageLayout"]//*[_type == "newsStory"]*[_type == "frontPageLayout" && name == "main"]{    sideStoriesPrimary[]-> {      _updatedAt,      authors[]->{name, profilePhoto{asset->{url}}},      title,      category,      excerpt,      slug,      featuredImage{asset->{url}}    },    sideStoriesSecondary[]-> {      _updatedAt,      authors[]->{name, profilePhoto{asset->{url}}},      title,      category,      excerpt,      slug,      featuredImage{asset->{url}}    },    topStory->{      _updatedAt,      authors[]->{name, profilePhoto{asset->{url}}},      title,      category,      excerpt,      slug,      featuredImage{asset->{url}}    }}[0]
...
// Query: *[_type == "newsStory" && slug.current == $slug]{  _updatedAt,  content[]{    ...,    _type == "image" => {      ...,      asset->    }  },  featuredImage{asset->{url}},  title,  category->{name, slug},  slug,  authors[]->{name, profilePhoto{asset->{url}, slug}},  excerpt}[0]
